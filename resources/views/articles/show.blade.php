    ...
    <div class="container col-xxl-8 px-4 py-5">
        <div class="row flex-lg-row-reverse align-items-center g-5 py-5">
            <div class="col-10 col-sm-8 col-lg-6">
                <img src="{{ url('images/', $article->image_path) }}"
                    class="d-block mx-lg-auto img-fluid rounded-5 shadow-lg" alt="Bootstrap Themes" width="700" height="500"
                    loading="lazy">
            </div>
            <div class="col-lg-6">
                ...
                <div class="d-grid gap-2 d-md-flex justify-content-md-start">
                    <div class="col">
                        <img src="{{ url('images', $article->user->avatar_path) }}" alt="Bootstrap" width="32" height="32"
        ...
        @if (Auth::check())
            <form action="{{ route('comment', $article->id) }}" method="POST" class="row g-3">
                ...
                <div class="col-auto">
                    ...
                    <textarea name="content" type="text" class="form-control" id="comment"
        ...
        @forelse ($article->comments as $comment )
            <div class="d-flex text-muted pt-3">
                <img class="bd-placeholder-img flex-shrink-0 me-2 rounded" width="32" height="32"
                    src="{{ url('images', $comment->user->avatar_path) }}" role="img" focusable="false">
