                ...
                <div class="col d-flex justify-content-center">
                    <div class="card card-cover h-20 overflow-hidden text-white bg-dark rounded-5 shadow-lg mw-50"
                        ...
                        <div class="card-header">
                            <div class="dropdown float-end">
                                ...
                                <ul class="dropdown-menu dropdown-menu-dark" aria-labelledby="dropdownMenuButton2">
                                    <li><a class="dropdown-item"
                                            href="{{ route('articles.edit', $article->slug) }}">{{ __('Update') }}</a>
                                    </li>
                                    <li><a class="dropdown-item"
                                            href="{{ route('articles.show', $article->slug) }}">{{ __('View') }}</a>
                                    </li>
                                    <li>
                            ...
                            <img src="{{ url('images/', $userdetales->avatar_path) }}" alt="Avatar" width="32"
                                height="32" class="rounded-circle border border-white">
                            <div class="card-body">
                                <div class=" flex-column h-20 p-5 pb-3 text-white text-shadow-1">
                                    <h2 class=" min-vw-50 pt-1 mt-1 mb-1 display-8 lh-1 fw-bold">
                                        {{ $article->title }}</h2>
                                </div>
                            </div>
